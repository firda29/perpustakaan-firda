            ...
            <div class="col-md-12">
                <form method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <select name="id_buku" class="form-control">
                                ...
                                ?>
                                <option <?php if($query['id_buku'] == $buku['id_buku']) echo 'selected'; ?> value="<?php echo $buku['id_buku'];?>"><?php echo $buku['judul'];?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <textarea name="ulasan" rows="5" class="form-control"><?php echo $query['ulasan']; ?></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <select name="rating" class="form-control">
                                <?php
                                    for($i = 1; $i<=10; $i++) {
                                ?>
                                    <option <?php if($query['rating'] == $i) echo 'selected'; ?>><?php echo $i; ?></option>
                                <?php
                                    }
                                ?>                               
                            </select>
